...
//////////////////////////////////////////////設定項目/////////////////////////////////////////////////////
	...
	cols=256;				//横幅
	rows=256;				//縦幅
	sin_frequency=0.015625;	//sin波の周波数．3k:0.070313 , 10k:0.046875 , 100k:0.015625
	degree=3;				//sin波を回転させる角度　[°]
	step=121;				//sin波を回転させる角度の刻み幅
	bold=2;					//sin波の太さ
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	for(j=half_rows-(bold/2)+1;j<=half_rows+(bold/2)+correction;++j){
		...
		input_sin[i][j]=(sin(2*PI*sin_frequency*i+(PI/2))+1)*180; //0~255でsin波を表現
